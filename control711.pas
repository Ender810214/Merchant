...
uses
  ...
  cxContainer, cxEdit, dxSkinsCore, cxDropDownEdit, cxCalendar, cxDBEdit,
  cxTextEdit,
...
type
  TFcontrol711 = class(TForm)
    ...
    Qcontrol711facturaid: TFloatField;
    Label10: TLabel;
...
begin
  if MessageDlg
    ('Está a punto de registrar un documento, esta acción es irreversible, esta seguro(a) de querer continuar',
