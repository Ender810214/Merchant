  ...
  object CurvyPanel1: TCurvyPanel
    ...
    object CurvyPanel2: TCurvyPanel
      ...
      object Label4: TLabel
        ...
        Width = 122
        Height = 13
        Caption = 'Precio de Referencia CUP'
      ...
      object Label9: TLabel
        ...
        Width = 145
        Height = 13
        Caption = 'Precio de Referencia USD (CL)'
      ...
      object cxDBTextEdit3: TcxDBTextEdit
        Left = 157
        Top = 91
        DataBinding.DataField = 'cod_pieza'
        DataBinding.DataSource = DataSource1
        TabOrder = 7
        Width = 178
      end
      ...
      object cxDBCalcEdit5: TcxDBCalcEdit
        Left = 587
        Top = 152
        DataBinding.DataField = 'precio_total'
        DataBinding.DataSource = DataSource1
        TabOrder = 9
        Width = 121
      end
      ...
      object cxDBDateEdit1: TcxDBDateEdit
        Left = 255
        Top = 208
        DataBinding.DataField = 'fecha_desarrollo'
        DataBinding.DataSource = DataSource1
        TabOrder = 11
        Width = 121
      end
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        ConditionalFormatting = {
          ...
          61004200610072003C000000010000000000000001000000FFFFFF7F00000000
          0000000000000001000000000000000000000000010000000000002000000020
          FFFFFF1F008BEF00}
        ...
        object cxGrid1DBTableView1descripcion: TcxGridDBColumn
          Caption = 'Desripci'#243'n'
          DataBinding.FieldName = 'descripcion'
          Width = 400
        end
        object cxGrid1DBTableView1cod_pieza: TcxGridDBColumn
          Caption = 'Cod de Pieza'
          DataBinding.FieldName = 'cod_pieza'
        end
        object cxGrid1DBTableView1productoid: TcxGridDBColumn
          DataBinding.FieldName = 'productoid'
        end
        object cxGrid1DBTableView1nuevo: TcxGridDBColumn
          Caption = 'Nuevo'
          DataBinding.FieldName = 'nuevo'
          Width = 40
        end
        object cxGrid1DBTableView1fecha_desarrollo: TcxGridDBColumn
          Caption = 'Fecha de Desarrollo'
          DataBinding.FieldName = 'fecha_desarrollo'
          Width = 100
        end
      end
