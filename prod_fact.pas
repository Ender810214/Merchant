...
type
  TFprod_fact = class(TForm)
    ...
    QProd_Factfecha_factura: TDateField;
...
begin
  ...
  QProd_Factfecha_factura.Value := ffacturas.UniQuery2fecha.Value;
...
begin
  ...
  begin
    ShowMessage
      ('La Cantidad a Facturar Supera la Cantidad Disponible del Producto, Revise ');
    QProd_Fact.Cancel;
  end;
end;
