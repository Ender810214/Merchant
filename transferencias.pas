...
type
  TFTransferencias = class(TForm)
    ...
    CheckBox1: TCheckBox;
    cxGrid1DBTableView1cambio_precio_usd: TcxGridDBColumn;
    Qtransfnuevo_precio_usd: TFloatField;
    cxDBCalcEdit1: TcxDBCalcEdit;
    cxGrid1DBTableView1nuevo_precio_usd: TcxGridDBColumn;
...
begin
  ...
  begin
    ...
    UniStoredProc1.ParamByName('in_cambio_precio').Value:=Qtransfcambio_precio_usd.Value;
     if    UniStoredProc1.ParamByName('in_cambio_precio').Value='' then    UniStoredProc1.ParamByName('in_cambio_precio').Value:='N';
    if Qtransfcambio_precio_usd.Value='S' then
     begin
      UniStoredProc1.ParamByName('in_cambio_precio').Value:='S';
      UniStoredProc1.ParamByName('in_nuevo_precio_usd').Value:=Qtransfnuevo_precio_usd.Value;
    end;
