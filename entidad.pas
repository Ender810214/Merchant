...
uses
  ...
  cxContainer, cxEdit, dxSkinsCore, cxTextEdit, cxDBEdit, Vcl.StdCtrls,
  cxNavigator,
...
type
  TFEntidad = class(TForm)
    ...
    Label7: TLabel;
    Label10: TLabel;
    QEntidadescuenta_usd_far: TStringField;
    QEntidadessucursal_usd_far: TStringField;
    QEntidadescuenta_usd_gae: TStringField;
    QEntidadessucursal_usd_gae: TStringField;
    Label11: TLabel;
    ...
    QEntidadescorreo_electronico: TStringField;
    Label15: TLabel;
