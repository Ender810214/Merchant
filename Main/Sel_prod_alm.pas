...
procedure TFSel_Prod_Alm.AdvSmoothButton3Click(Sender: TObject);
begin
  UniStoredProc2.ParamByName('in_contrato').Value :=Ffacturas.UniQuery2contratoid.Value;
  UniStoredProc2.ParamByName('in_cliente').Value := Ffacturas.UniQuery2clienteid.Value;
  UniStoredProc2.ParamByName('in_factura').Value := Ffacturas.UniQuery2facturaid.Value;
  UniStoredProc2.ParamByName('in_fecha').Value := Ffacturas.UniQuery2fecha.Value;
  UniStoredProc2.ExecSQL;
  Fprod_fact.QProd_Fact.Refresh;
  Close;
end;

procedure TFSel_Prod_Alm.FormShow(Sender: TObject);
begin
  UniQuery1.ParamByName('contrato').Value :=
    Ffacturas.UniQuery2contratoid.Value;
