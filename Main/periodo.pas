...
uses
  ...
  dxScrollbarAnnotations, Data.DB, cxDBData, MemDS, DBAccess, Uni, cxGridLevel,
  cxClasses, cxGridCustomView, cxGridCustomTableView, cxGridTableView,
  cxGridDBTableView, cxGrid, dxDateTimeWheelPicker, cxDropDownEdit;
...
type
  TFPeriodo = class(TForm)
    ...
    cxGrid1DBTableView1periodoid: TcxGridDBColumn;
...
procedure TFPeriodo.FormCreate(Sender: TObject);
begin
  Qperiodo.Open;
end;
